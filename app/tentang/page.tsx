...
export default function TentangPage() {
  return (
    <main className="min-h-screen bg-[#f4f5f7] dark:bg-black">
      ...
      {/* SECTION 1 — Hero — bg-[#f4f5f7] */}
      <section className="bg-[#f4f5f7] dark:bg-black">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 md:px-8 py-16 sm:py-20 md:py-24 lg:py-28 text-center">
          <p className="mb-3 sm:mb-4 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] sm:tracking-[0.25em] md:tracking-[0.3em] text-indigo-400">
            Tentang Kami
          </p>

          <h1 className="mb-4 sm:mb-5 md:mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white leading-[1.1] sm:leading-[1.2] md:leading-tight">
          ...
          <p className="mx-auto max-w-3xl px-2 sm:px-4 md:px-0 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-slate-600 dark:text-gray-300 md:dark:text-gray-400">
      ...
      {/* SECTION 2 — Siapa Kami / Stats — bg-white */}
      ...
      {/* SECTION 3 — Visi & Misi — bg-[#eef0f3] (light) / image (dark) */}
      <section className="relative z-10 bg-[#eef0f3] dark:bg-[#0a0a0a]">
        {/* Background image hanya tampil di dark mode */}
        <div
          className="absolute inset-0 -z-50 hidden dark:block bg-cover bg-center bg-fixed"
          style={{
            backgroundImage: "url('/assets/pictures/background7.jpg')",
          }}
        />
        <div className="absolute inset-0 -z-40 hidden dark:block bg-black/50" />
        <div
      ...
      {/* SECTION 4 — Cara Kami Bekerja — bg-white */}
      <section className="bg-white dark:bg-white/[0.01] py-24">
      ...
      {/* SECTION 5 — Perjalanan Kami — bg-[#eef0f3] (light) / image (dark) */}
      <section className="relative z-10 bg-[#eef0f3] dark:bg-[#0a0a0a]">
        <div
          className="absolute inset-0 -z-50 hidden dark:block bg-cover bg-center bg-fixed"
          style={{
        ...
        />
        <div className="absolute inset-0 -z-40 hidden dark:block bg-black/80" />
        <div
          className="absolute inset-0 -z-40 pointer-events-none hidden dark:block"
          style={{ background: 'radial-gradient(ellipse at center, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 70%)' }}
        />
      ...
      {/* SECTION 6 — Tim Pengembang — bg-white */}
      <section className="bg-white dark:bg-black">
        <div className="mx-auto max-w-7xl px-6 py-24">
          <div className="text-center mb-16">
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-indigo-500">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <div className="mb-5 text-4xl text-slate-900 dark:text-white">{item.icon}</div>
